...
function init(){
	...
	if(urlObject.query.webmap) {
		...
		var mapDeferred = esri.arcgis.utils.createMap(webmap, "map", {
			...
			geometryServiceURL: "http://maps.jeddah.gov.sa/ArcGIS/rest/services/Geometry/GeometryServer"
		...
		var basemap = new esri.layers.ArcGISTiledMapServiceLayer("http://rastermaps.jeddah.gov.sa/arcgis/rest/services/Aerial_2011/MapServer", {
				id: 'basemap'
			});
		...
		var basemap2 = new esri.layers.ArcGISTiledMapServiceLayer("http://mapstore.jeddah.gov.sa/ArcGIS/rest/services/JeddahBaseMap_C_mxd_A/MapServer", {
		    id: 'basemap2', opacity: 0.8
		});
		currentBasemap = basemap2;
		map.addLayer(currentBasemap);
		...
		var rivers = new esri.layers.FeatureLayer("http://mapstore.jeddah.gov.sa/arcgis/rest/services/JeddahBaseMap_C_mxd_A/MapServer/1", {
...
function getBasemapUrl(service){
    ...
    return 'http://rastermaps.jeddah.gov.sa/arcgis/rest/services/Aerial_2011/MapServer';
